...
public class CarouselViewAdapter extends RecyclerView.Adapter<CarouselViewAdapter.CarouselAdapterViewHolder> {
    ...
    private final boolean isOffsetStart;
    private final int spacing;

    CarouselViewAdapter(CarouselViewListener carouselViewListener, int resource, int size, RecyclerView recyclerView,
            int spacing, boolean isOffsetStart) {
